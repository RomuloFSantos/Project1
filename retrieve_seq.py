...
def main():
    ...
    parser_splice = subparsers.add_parser('splice', help='Performs a splice on a sequence')

    parser_splice.add_argument('-f', '--file', dest='file', action='store', help='A multifasta file', required=False)

    parser_splice.add_argument('-r', '--range', action='store', nargs='+',
                              help='A value in the form start-end space separated. 10-20 50-60 70-100')
